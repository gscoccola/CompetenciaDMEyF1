...
setwd("C:\\Users\\PC\\Desktop\\DMEyF")  #Establezco el Working Directory

#cargo el dataset
dataset  <- fread("./Competencia/competencia1_2022.csv")

#ctrx_quarter, mcuentas_saldo, cdescubierto_preacordado, active_quarter, mcuenta_corriente
#cprestamos_personales, mprestamos_personales, mcaja_ahorro
...
modelo  <- rpart(formula=   "clase_binaria ~ . -mcomisiones_mantenimiento -Visa_mpagado",
...
for( corte  in  c(9900) )
{
  ...
  fwrite( dfinal[ , list(numero_de_cliente, Predicted) ], #solo los campos para Kaggle
          file= paste0( "./kaggle/final/KA4120_005_",  corte, ".csv"),
          sep=  "," )
}
